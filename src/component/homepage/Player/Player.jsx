...
const Player = ({ playeData,coin,setCoin }) => {
    ...
    return (
        <div className='container mx-auto my-20'>
            ...
            {selectedType === 'available' ? <Availableplayer playerData={playerData} coin={coin} setCoin={setCoin} setselectedPlayer={setselectedPlayer} selectedPlayer={selectedPlayer}></Availableplayer>:<Selectedplayer selectedPlayer={selectedPlayer} setselectedPlayer={setselectedPlayer} coin={coin} setCoin={setCoin} setselectedType={setselectedType}></Selectedplayer>    }        
        </div>
    );
};
